...
import { WrappedWorkerLogEntry, WrappedWorkerRequest, WrappedWorkerResponse } from './main'
...
const log = (level: WrappedWorkerLogEntry['level'], args: Array<unknown>): void => {
...
const logger: Omit<Logger, 'log' | 'levels' | 'errorHandler' | 'hooks'> = {
